        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Kualitas Produk</h4>
                        <p>Kualitas bagi kami adalah yang paling utama. Kami memberikan kualitas bahan yang sama dengan yang telah disepakati.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Garansi Produk</h4>
                        <p>Jaminan produk sesuai dengan pesanan. kami siap mengganti jika terdapat spesifikasi yang tidak sesuai karena kelalaian pihak kami.</p>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Harga yang ekonomis menjadi unggulan kami dengan kualitas premium. Kami memberikan jaminan harga termurah di antara yang lainnya.</p>
                    </div>
                </div>
                <!-- end of card -->
...
<!-- Services -->
<div id="services" class="cards-2 filter">
    <div class="container" style="max-width: 1185px;">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">LAYANAN KAMI</div>
                <h2>Anda Dapat Mempercayakan<br>Semua Kebutuhan Produksi Garment Anda</h2>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2>Pilih Paket Layanan<br>Sesuai Dengan Kebutuhan Anda</h2>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Minimal pembelian 2 lusin</div>
                            </li>
                            <%--<li class="media">
                                <i class="fas fa-square"></i>
                        ...
                        <p class="price">Mulai dari <span>Rp. 70.000 / kaos</span></p>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Minimal pembelian 10 lusin</div>
                            </li>
                            <%--<li class="media">
                                <i class="fas fa-square"></i>
                        ...
                        <p class="price">Mulai dari <span>Rp. 50.000 / kaos</span></p>
                    </div>
                    <div class="button-container">
                        <a class="btn-solid-reg page-scroll" href="#callMe">DETAILS</a>
                    </div> <!-- end of button-container -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Minimal pembelian 50 lusin</div>
                            </li>
                            <%--<li class="media">
                                <i class="fas fa-square"></i>
                        ...
                        <p class="price">Mulai dari <span>Rp. 30.000 / kaos</span></p>
                    </div>
                    <div class="button-container">
                        <a class="btn-solid-reg page-scroll" href="#callMe">DETAILS</a>
                    </div> <!-- end of button-container -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="p-heading">Setiap pelanggan bagi kami merupakan sebuah kesempatan yang menjadikan kami lebih baik</p>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="testimonial-text">"Kaa makasi yaa udh mau bantu postweek 2.0, bajunya baguss hehehe semoga taun depan bisa kejasama lagi.. sukses ya kaaa konveksinyaa"</div>
                                        <div class="testimonial-author">Panitia Postweek 2.0</div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="testimonial-text">"Makasih a hoodie nya memuaskan, semua anak kelas suka hehe"</div>
                                        <div class="testimonial-author">Seorang Siswa SMA</div>
                                    </div>
                                </div>
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
            ...
            <div class="col-lg-12">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="images/diki-2.png" alt="alternative">
                    </div> <!-- end of image-wrapper -->
                    <p class="p-large">Diki Muhammad Sidik</p>
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="images/briliant-2.png" alt="alternative">
                    </div> <!-- end of image wrapper -->
                    <p class="p-large">Briliant Hadi Akbar</p>
                ...
                <div class="team-member">
                    ...
                    <p class="job-title">Kang Desain</p>
                    <span class="social-icons">
                            <span class="fa-stack">
                                <a href="#your-link">
                                    <span class="hexagon"></span>
